...
const Login = () => {
  ...
  return (
    <section id="login" className="flex items-center bg-[#D1D5DB] w-full  justify-center min-h-[90vh]">
      <div className="bg-gray-900">
        <p className="text-center text-white text-2xl font-bold">Login</p>
        <div className="w-[600px] flex    text-gray-200">
          <div className="w-1/2 bg-gray-900  items-center justify-center">
            <img src={loginIcons} alt="login icon" className="mt-16" />
          </div>
          <div className="w-1/2 bg-gray-900 rounded-r-md p-8">
            ...
            <form className="mt-4" onSubmit={handleSubmit}>
              ...
              <div className="mt-1 text-sm relative">
                ...
                <div className="flex justify-end text-xs text-gray-400 mt-2">
                  <Link to="/forgot-password" className="hover:underline hover:text-violet-400">Forgot password?</Link>
                </div>
              </div>
              <button className="mt-4 w-full bg-violet-400 py-2 text-center text-gray-900 rounded-md font-semibold">Sign in</button>
            </form>
            ...
            <div className="flex justify-center mt-4 space-x-2">
              <button aria-label="Log in with Google" className="p-3 bg-transparent rounded-md">
              ...
              <button aria-label="Log in with Twitter" className="p-3 bg-transparent rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current text-white">
              ...
              <button aria-label="Log in with GitHub" className="p-3 bg-transparent rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current text-white">
            ...
            <p className="text-center text-xs text-gray-400 mt-4">
              ...
              <Link to={"/sign-up"} className="text-white hover:underline hover:text-violet-400"> Sign Up</Link>
            </p>
          </div>
